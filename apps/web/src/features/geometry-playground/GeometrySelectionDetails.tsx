...
} from "../geometry-2d/presentation/geometry-presentation-model-2d";
import type { GeometrySelection, GeometrySelectionState } from "../geometry-2d/selection/geometry-selection-state";
